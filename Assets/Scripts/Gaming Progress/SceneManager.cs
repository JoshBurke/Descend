...
public class SceneManager : MonoBehaviour
{
    ...
    void Awake() 
    {
        ...
        checkPointsManager = (CheckPointDataBase)sceneFolder.DeserializeDataBase(CheckPointFileNameOnDisk, typeof(CheckPointDataBase));
        checkPointsManager.SetCheckPoints(CheckPoints);
        enemiesManager = (EnemyDataBase)sceneFolder.DeserializeDataBase(EnemyFileNameOnDisk, typeof(EnemyDataBase));
        playerManager = (PlayerDataBase)sceneFolder.DeserializeDataBase(PlayerFileNameOnDisk, typeof(PlayerDataBase));
